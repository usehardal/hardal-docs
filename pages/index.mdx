...
import docsCard from "../public/assets/hardal-dashboard-dark.jpeg";
import docsEventCard from "../public/assets/hardal-create-event-docs.jpeg";

<div className="home-content">
  <div className="content-container">
    <h1 className="headline"> Next-gen web analytics platform</h1>
    <p className="subtitle">This documentation will guide you through the process of setting up and using Hardal for cookieless and privacy-first web analytics in <strong>web2</strong> and <strong>web3</strong> ecosystem.</p>
    <p className="subtitle">
      <Link className={styles.cta} href="/docs">Get started <span>→</span></Link>
       <Link className={styles.ctaSecondary} href="https://app.usehardal.com/share/hardal-demo?utm_source=hardal-docs">Demo <span>→</span></Link>
    </p>
...
<style jsx>{`
  ...
  .headline {
    ...
    margin-top: 3.4rem;
    line-height: 1.7;
    background-image: linear-gradient(146deg, #000, #df15c4);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    background-clip: text;
  }
  :global(.dark) .headline {
    background-image: linear-gradient(146deg, #fff, #df15c4);
  }
  .subtitle {
    font-size: 1.3rem;
      ...
      <Features>
        <Feature index={0} large centered id="docs-card" href="/docs">
         <Image 
              ...
              width={200}
              height={50}
              alt="Full-power cookieless Hardal in minutes" loading="eager" />
           <Image 
              src={docsCard}
              width={200}
              height={50}
              alt="Full-power cookieless Hardal in minutes" loading="eager" />
          <h3>Full-power cookieless <br className="show-on-mobile"/>in minutes.</h3>
        </Feature>
        <Feature index={1} centered className="card-with-border" href="/docs">
          <div className="h-full flex flex-col justify-between">
            <h3>Create custom events <br className="show-on-mobile"/> <span style={{ fontWeight: 300 }}>in a single line</span>.</h3>
            <p className='text-left mb-8'>Measure every steps your users, using client-side method.</p>
            <div>
               <Image  src={docsEventCard} className={cn(styles.radius)}/>
              ...
              <div className={styles.optimization}>
                <div style={{ fontSize: '.9rem' }} className="leading-8">
                  <code>{`hardal.trackEvents("YOUR_EVENT_ID")`}</code>
                </div>
              </div>
            </div>
          </div>
